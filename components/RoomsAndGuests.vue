...
export default {
  ...
  methods: {
    increase (type, n, i) {
      switch (type) {
        ...
        case 'adults':
          ...
          break
        case 'children':
          if (this.children[n - 1] > 3) { this.children[n - 1] = 4 } else {
        ...
        case 'age':
          switch (n) {
            case 1:
              if (this.childrenAges[i - 1] > 11) { this.childrenAges[i - 1] = 12 } else {
              ...
              break
            case 2:
              if (this.childrenAges[(i - 1) + this.childrenNumber1] > 11) { this.childrenAges[(i - 1) + this.childrenNumber1] = 12 } else {
              ...
              break
            case 3:
              if (this.childrenAges[(i - 1) + this.childrenNumber2 + this.childrenNumber1] > 11) { this.childrenAges[(i - 1) + this.childrenNumber2 + this.childrenNumber1] = 12 } else {
              ...
              break
            case 4:
              if (this.childrenAges[(i - 1) + this.childrenNumber3 + this.childrenNumber2 + this.childrenNumber1] > 11) { this.childrenAges[(i - 1) + this.childrenNumber3 + this.childrenNumber2 + this.childrenNumber1] = 12 } else {
              ...
              break
            case 5:
              if (this.childrenAges[(i - 1) + this.childrenNumber4 + this.childrenNumber3 + this.childrenNumber2 + this.childrenNumber1] > 11) { this.childrenAges[(i - 1) + this.childrenNumber4 + this.childrenNumber3 + this.childrenNumber2 + this.childrenNumber1] = 12 } else {
              ...
              break
            case 6:
              if (this.childrenAges[(i - 1) + this.childrenNumber5 + this.childrenNumber4 + this.childrenNumber3 + this.childrenNumber2 + this.childrenNumber1] > 11) { this.childrenAges[(i - 1) + this.childrenNumber5 + this.childrenNumber4 + this.childrenNumber3 + this.childrenNumber2 + this.childrenNumber1] = 12 } else {
    ...
    save () {
      ...
      this.label = `${this.guests.length} rooms, ${adults + children} guests`
      if (this.$route.name === 'trips-city-slug' || this.$route.name === 'roomsResults') { this.$emit('save', this.guests) } else { this.$store.dispatch('setHotelGuestsInfo', this.guests) }
    //   this.menu = false
    }
  }
}

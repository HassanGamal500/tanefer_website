          ...
          <v-row>
            ...
            <v-col cols="12" md="9">
              <v-card class="pa-3">
                ...
                <div v-for="(hotel, h) in listGtaHotelDetails" :key="h">
                  <v-card class="hotel-card mb-2" max-width="650px" elevation="2">
                    <v-row no-gutters>
                      <!-- Hotel Image -->
                      <v-col cols="4">
                        <v-img
                        ...
                        <div class="d-flex justify-space-between align-center mb-1">
                          <div>
                            ...
                            <span class="grey--text text-justify">
                              <span v-html="formatLastParts(hotel.HotelInfo.Address) || 'Location'" /> - <a href="#">Map</a>
                            </span>
                          </div>
                        </div>

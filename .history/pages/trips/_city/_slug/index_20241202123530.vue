                  ...
                  <v-stepper-content step="2">
                    ...
                    <div v-if="!confirmedSelectedRoom && !showInfoOfRooms">
                      ...
                      : hotel.Images?.Image[0]?.Type === 'THB'
                        ? hotel.Images?.Image[0]?.FileName
                        : 'https://images.unsplash.com/photo-1496417263034-38ec4f0b665a?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'"                              alt="Hotel Image"
  ...
  watch: {
    ...
    packageStartDay (newDate) {
      if (newDate) {
        ...
        // added to define the activity days
